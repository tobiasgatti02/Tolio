...
export default function StripeAccountCheck() {
  ...
  // Siempre retornar null - el componente está deshabilitado temporalmente
  // Si hasStripeAccount es false, en el futuro mostrar el aviso de configuración
  if (loading || hasStripeAccount === null || hasStripeAccount) {
    return null
  }

  // TODO: Descomentar cuando se quiera mostrar el aviso de Stripe
  // return (
