...
export default function CleanDashboard({ 
  ...
  // Redirect buyers to bookings if accessing other pages
  useEffect(() => {
    if (isBuyerContext && pathname !== `/${locale}/dashboard` && !['expenses', 'bookings', 'calendar', 'reviews', 'settings'].some(page => pathname.includes(`/dashboard/${page}`))) {
