...
import { Package, Calendar, Star, Settings, Clock, CheckCircle, XCircle, PenTool } from "lucide-react"
            ...
            {bookings.length === 0 ? (
              ...
              <div className="space-y-6">
                {bookings.map((booking) => {
                  ...
                  const handleReservationStatus = async (bookingId: string, status: string): Promise<void> => {
